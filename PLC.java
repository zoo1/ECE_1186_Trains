...
public class PLC {
	...
	//This goes through the path and decides if it is a switch block and if it is, decides if
	//the switch needs to be toggled or not based on the next block
				...
				if(commandType.equals("path")) {
					...
					for (int i = 0; i < route.length; i++) {
						...
						if (subjectType.equals("red")) {
							if (route[i].equals("1") && route[j].equals("15")) {
							...
							else if (route[i].equals("1") && route[j].equals("16")) {
							...
							if (route[i].equals("27") && route[j].equals("28")) {
							...
							else if (route[i].equals("27") && route[j].equals("76")) {
							...
							if (route[i].equals("32") && route[j].equals("33")) {
							...
							else if (route[i].equals("32") && route[j].equals("72")) {
							...
							if (route[i].equals("38") && route[j].equals("39")) {
							...
							else if (route[i].equals("38") && route[j].equals("71")) {
							...
							if (route[i].equals("43") && route[j].equals("44")) {
							...
							else if (route[i].equals("43") && route[j].equals("67")) {
							...
							if (route[i].equals("52") && route[j].equals("53")) {
							...
							else if (route[i].equals("52") && route[j].equals("66")) {
							...
							if (route[i].equals("9") && route[j].equals("10")) {
							...
							else if (route[i].equals("9") && route[j].equals("77")) {
							...
							if (route[i].equals("61") && route[j].equals("62")) {
							...
							else if (route[i].equals("61") && route[j].equals("152")) {
							...
							if (route[i].equals("1") && route[j].equals("12")) {
							...
							else if (route[i].equals("1") && route[j].equals("13")) {
							...
							if (route[i].equals("28") && route[j].equals("29")) {
							...
							else if (route[i].equals("28") && route[j].equals("150")) {
							...
							if (route[i].equals("57") && route[j].equals("58")) {
							...
							else if (route[i].equals("57") && route[j].equals("151")) {
							...
							if (route[i].equals("76") && route[j].equals("77")) {
							...
							else if (route[i].equals("76") && route[j].equals("101")) {
							...
							if (route[i].equals("85") && route[j].equals("86")) {
							...
							else if (route[i].equals("85") && route[j].equals("100")) {
